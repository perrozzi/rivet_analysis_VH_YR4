...
HIST_ZNN_HSTABLE_MG5AMCNLO_PY8=mg5amcnlo/ZnnH_PY8-FxFx_Hnotdecayed_new.yoda
HIST_ZNN_HSTABLE_MG5AMCNLO_HW7=mg5amcnlo/ZnunuHjets_HW7-FxFx_Hnotdecayed_new.yoda
HIST_ggHZNN_HSTABLE_MG5AMCNLO_PY8_UNMERGED=mg5amcnlo/gghz_MC_ZnunuHbb_undecayed_new.yoda
...
# $HIST_ZLL_HSTABLE_MG5AMCNLO_PY8:ErrorBands=1:ErrorBandColor=green:ErrorBandOpacity=0.5:RatioPlotErrorBandColor=green:LineColor=green:Title='ZllH MG5_aMC+PY8' \
# $HIST_ggHZLL_HSTABLE_MG5AMCNLO_PY8_UNMERGED:Scale=0.7:ErrorBands=1:ErrorBandColor=gray:ErrorBandOpacity=0.5:RatioPlotErrorBandColor=gray:LineColor=gray:Title='ggZllH MG5_aMC+PY8'
...
# $HIST_ZNN_HSTABLE_MG5AMCNLO_PY8:ErrorBands=1:ErrorBandColor=green:ErrorBandOpacity=0.5:RatioPlotErrorBandColor=green:LineColor=green:Title='ZNNH MG5_aMC+PY8' \
...
# YR4_HZNN_vs_ggHZNN_HSTABLE_aMCNLO
rivet-mkhtml --cm -o $OUTDIR/YR4_HZNN_vs_ggHZNN_HSTABLE_aMCNLO \
$HIST_ZNN_HSTABLE_MG5AMCNLO_PY8:ErrorBands=1:ErrorBandColor=green:ErrorBandOpacity=0.5:RatioPlotErrorBandColor=green:LineColor=green:Title='ZnunuH MG5_aMC+PY8' \
$HIST_ggHZNN_HSTABLE_MG5AMCNLO_PY8_UNMERGED:Scale=0.7:ErrorBands=1:ErrorBandColor=gray:ErrorBandOpacity=0.5:RatioPlotErrorBandColor=gray:LineColor=gray:Title='ggZnunuH MG5_aMC+PY8'
...
cp -r Plots/YR4_HZNN_vs_ggHZNN_HSTABLE_aMCNLO ~/www/rivet_analysis_VH_YR4/
...
cp -r /afs/cern.ch/user/p/perrozzi/www/dyres/index.php ~/www/rivet_analysis_VH_YR4/YR4_HZNN_vs_ggHZNN_HSTABLE_aMCNLO/MC_ZnunuHbb_undecayed

# cp -r Plots/YR4_HZLL_HDECAYED_POW_vs_aMCNLO /afs/cern.ch/work/p/perrozzi/private/tdr2/LHCHXSWG_YR4/cernrep4/trunk/WG1/VBFplusVH/VHNLOPS
# cp -r Plots/YR4_HZLL_HSTABLE_POW_vs_aMCNLO /afs/cern.ch/work/p/perrozzi/private/tdr2/LHCHXSWG_YR4/cernrep4/trunk/WG1/VBFplusVH/VHNLOPS
# cp -r Plots/YR4_HZLL_vs_ggHZLL_HSTABLE_aMCNLO /afs/cern.ch/work/p/perrozzi/private/tdr2/LHCHXSWG_YR4/cernrep4/trunk/WG1/VBFplusVH/VHNLOPS
# cp -r Plots/YR4_HZNN_HSTABLE_POW_vs_aMCNLO /afs/cern.ch/work/p/perrozzi/private/tdr2/LHCHXSWG_YR4/cernrep4/trunk/WG1/VBFplusVH/VHNLOPS
# cp -r Plots/YR4_HZNN_HDECAYED_POW_vs_aMCNLO /afs/cern.ch/work/p/perrozzi/private/tdr2/LHCHXSWG_YR4/cernrep4/trunk/WG1/VBFplusVH/VHNLOPS
cp -r Plots/YR4_HZNN_vs_ggHZNN_HSTABLE_aMCNLO /afs/cern.ch/work/p/perrozzi/private/tdr2/LHCHXSWG_YR4/cernrep4/trunk/WG1/VBFplusVH/VHNLOPS
